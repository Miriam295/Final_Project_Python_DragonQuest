...
def sea():
    ...
    if c == 1:
        if money.count_money() < 100:
            ...
            time.sleep(2)
            print("\nIt is the most comfortable ride, but you made it to the other side of the sea.")
    if c == 2:
        time.sleep(2)
        print("It is not the nicest swim, but a good practice! You gain +1 skills.")
        skill.gain_skills()
